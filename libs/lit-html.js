...
System.register("lib/dom", [], function (exports_2, context_2) {
  ...
  return {
    ...
    execute: function () {
      ...
      exports_2(
        "isCEPolyfill",
        isCEPolyfill = typeof window !== "undefined" &&
            ...
            if (node.nodeType === 1 /* Node.ELEMENT_NODE */) {
              if (node.hasAttributes()) {
                ...
                while (count-- > 0) {
                  ...
                  // the suffix.
                  const attributeLookupName = name.toLowerCase() +
                    boundAttributeSuffix;
...
System.register(
  "lib/template-instance",
  ["lib/dom", "lib/template"],
        ...
        TemplateResult = class TemplateResult {
          ...
          getHTML() {
            ...
            for (let i = 0; i < l; i++) {
              ...
              const attributeMatch = template_js_2.lastAttributeNameRegex.exec(
                s,
              );
              if (attributeMatch === null) {
                ...
                // below.
                html += s +
                  (isCommentBinding ? commentMarker : template_js_2.nodeMarker);
              } else {
                // For attributes we use just a marker sentinel, and also append a
                // $lit$ suffix to the name to opt-out of attribute-specific parsing
                // that IE and Edge do for style and certain SVG attributes.
                html += s.substr(0, attributeMatch.index) + attributeMatch[1] +
                  attributeMatch[2] + template_js_2.boundAttributeSuffix +
                  attributeMatch[3] +
...
System.register(
  ...
  function (exports_7, context_7) {
    ...
    var directive_js_1,
      dom_js_3,
      part_js_1,
      template_instance_js_1,
      template_result_js_1,
      template_js_3,
      isPrimitive,
      isIterable,
      AttributeCommitter,
      ...
      execute: function () {
        ...
        NodePart = class NodePart {
          ...
          appendInto(container) {
            this.startNode = container.appendChild(
              template_js_3.createMarker(),
            );
          ...
          __commitTemplateResult(value) {
            ...
            if (
              this.value instanceof template_instance_js_1.TemplateInstance &&
              ...
              const instance = new template_instance_js_1.TemplateInstance(
                template,
                value.processor,
                this.options,
              );
...
System.register(
  "lib/default-template-processor",
  ["lib/parts"],
      ...
      execute: function () {
        ...
        DefaultTemplateProcessor = class DefaultTemplateProcessor {
          ...
          handleAttributeExpressions(element, name, strings, options) {
            const prefix = name[0];
            if (prefix === ".") {
              const committer = new parts_js_1.PropertyCommitter(
                element,
                name.slice(1),
                strings,
              );
            ...
            if (prefix === "?") {
              return [
                new parts_js_1.BooleanAttributePart(
                  element,
                  name.slice(1),
                  strings,
                ),
            ...
            const committer = new parts_js_1.AttributeCommitter(
              element,
              name,
              strings,
            );
  ...
  function (exports_9, context_9) {
    ...
    function templateFactory(result) {
      ...
      if (template === undefined) {
        ...
        template = new template_js_4.Template(
          result,
...
System.register(
  "lib/render",
  ["lib/dom", "lib/parts", "lib/template-factory"],
    ...
    return {
      setters: [
        function (default_template_processor_js_1_1) {
          ...
          exports_11({
            "DefaultTemplateProcessor":
              default_template_processor_js_1_1["DefaultTemplateProcessor"],
            "defaultTemplateProcessor":
              default_template_processor_js_1_1["defaultTemplateProcessor"],
          });
        },
      ...
      execute: function () {
        ...
        exports_11(
          "html",
          html = (strings, ...values) =>
            new template_result_js_2.TemplateResult(
              strings,
              values,
              "html",
              default_template_processor_js_1.defaultTemplateProcessor,
            ),
        );
        /**
        ...
        exports_11(
          "svg",
          svg = (strings, ...values) =>
            new template_result_js_2.SVGTemplateResult(
              strings,
              values,
              "svg",
              default_template_processor_js_1.defaultTemplateProcessor,
